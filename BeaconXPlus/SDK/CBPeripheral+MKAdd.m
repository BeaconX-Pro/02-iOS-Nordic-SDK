...
static const char *iBeaconNotifySuccessKey = "iBeaconNotifySuccessKey";
static const char *disconnectListenSuccessKey = "disconnectListenSuccessKey";
...
- (void)updateCurrentNotifySuccess:(CBCharacteristic *)characteristic {
    if ([characteristic.UUID isEqual:[CBUUID UUIDWithString:iBeaconNotifyUUID]]) {
        objc_setAssociatedObject(self, &iBeaconNotifySuccessKey, @(YES), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        return;
    }
    if ([characteristic.UUID isEqual:[CBUUID UUIDWithString:disconnectListenUUID]]) {
        objc_setAssociatedObject(self, &disconnectListenSuccessKey, @(YES), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        return;
    }
}
...
- (void)setNil{
    ...
    objc_setAssociatedObject(self, &slotTypeKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    objc_setAssociatedObject(self, &battery, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    
    objc_setAssociatedObject(self, &disconnectListenKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    objc_setAssociatedObject(self, &threeSensorKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    objc_setAssociatedObject(self, &temperatureHumidityKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    objc_setAssociatedObject(self, &recordTHKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    ...
    objc_setAssociatedObject(self, &iBeaconNotifySuccessKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    objc_setAssociatedObject(self, &disconnectListenSuccessKey, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (BOOL)connectSuccess{
    if (![objc_getAssociatedObject(self, &iBeaconNotifySuccessKey) boolValue] || ![objc_getAssociatedObject(self, &disconnectListenSuccessKey) boolValue]) {
        return NO;
    }
