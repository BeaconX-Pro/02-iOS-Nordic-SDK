...
@implementation MKBXTriggerHumidityViewModel
@end

@interface MKBXTriggerHumidityView ()
...
@implementation MKBXTriggerHumidityView
...
- (void)sliderValueChanged {
    ...
    [self updateNoteMsg];
    if ([self.delegate respondsToSelector:@selector(mk_bx_triggerHumidityThresholdValueChanged:)]) {
        [self.delegate mk_bx_triggerHumidityThresholdValueChanged:[value floatValue]];
    }
}
...
- (void)startLabelPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(mk_bx_triggerHumidityStartStatusChanged:)]) {
        [self.delegate mk_bx_triggerHumidityStartStatusChanged:YES];
    }
}
...
- (void)stopLabelPressed {
    ...
    [self updateSlectedIcon];
    if ([self.delegate respondsToSelector:@selector(mk_bx_triggerHumidityStartStatusChanged:)]) {
        [self.delegate mk_bx_triggerHumidityStartStatusChanged:NO];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKBXTriggerHumidityViewModel *)dataModel {
    _dataModel = nil;
...
- (void)updateSlectedIcon {
    self.startIcon.image = (self.start ? LOADICON(@"MKBeaconXCustomUI", @"MKBXTriggerHumidityView", @"mk_bx_slotConfigSelectedIcon.png") : LOADICON(@"MKBeaconXCustomUI", @"MKBXTriggerHumidityView", @"mk_bx_slotConfigUnselectedIcon.png"));
    self.stopIcon.image = (self.start ? LOADICON(@"MKBeaconXCustomUI", @"MKBXTriggerHumidityView", @"mk_bx_slotConfigUnselectedIcon.png") : LOADICON(@"MKBeaconXCustomUI", @"MKBXTriggerHumidityView", @"mk_bx_slotConfigSelectedIcon.png"));
}
...
- (UIImageView *)startIcon {
    if (!_startIcon) {
        ...
        _startIcon.image = LOADICON(@"MKBeaconXCustomUI", @"MKBXTriggerHumidityView", @"mk_bx_slotConfigSelectedIcon.png");
    }
    return _startIcon;
}
...
- (UIImageView *)stopIcon {
    if (!_stopIcon) {
        ...
        _stopIcon.image = LOADICON(@"MKBeaconXCustomUI", @"MKBXTriggerHumidityView", @"mk_bx_slotConfigUnselectedIcon.png");
    }
    return _stopIcon;
}
