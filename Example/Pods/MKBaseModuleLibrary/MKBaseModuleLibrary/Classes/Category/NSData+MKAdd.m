...
- (NSString *)mk_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)mk_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)mk_hmacMD5StringWithKey:(NSString *)key {
    return [self mk_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)mk_hmacMD5DataWithKey:(NSData *)key {
    return [self mk_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)mk_hmacSHA1StringWithKey:(NSString *)key {
    return [self mk_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)mk_hmacSHA1DataWithKey:(NSData *)key {
    return [self mk_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)mk_hmacSHA224StringWithKey:(NSString *)key {
    return [self mk_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)mk_hmacSHA224DataWithKey:(NSData *)key {
    return [self mk_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)mk_hmacSHA256StringWithKey:(NSString *)key {
    return [self mk_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)mk_hmacSHA256DataWithKey:(NSData *)key {
    return [self mk_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)mk_hmacSHA384StringWithKey:(NSString *)key {
    return [self mk_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)mk_hmacSHA384DataWithKey:(NSData *)key {
    return [self mk_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)mk_hmacSHA512StringWithKey:(NSString *)key {
    return [self mk_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)mk_hmacSHA512DataWithKey:(NSData *)key {
    return [self mk_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)mk_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)mk_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)mk_dataWithHexString:(NSString *)hexStr {
...
+ (NSData *)mk_dataWithBase64EncodedString:(NSString *)base64EncodedString {
...
+ (NSData *)mk_dataNamed:(NSString *)name {
