...
void MK_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void MK_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void MK_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void MK_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void MK_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void MK_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void MK_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void MK_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
static BOOL hexStrToRGBA(NSString *str,
    ...
    str = [[str mk_stringByTrim] uppercaseString];
    if ([str hasPrefix:@"#"]) {
...
- (BOOL)mk_getHue:(CGFloat *)hue
    ...
    MK_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}
...
- (BOOL)mk_getCyan:(CGFloat *)cyan
    ...
    MK_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
