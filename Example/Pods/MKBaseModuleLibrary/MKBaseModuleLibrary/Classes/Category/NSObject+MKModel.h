 ...
 */
+ (nullable instancetype)mk_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)mk_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)mk_modelToJSONObject;
 ...
 */
- (nullable NSData *)mk_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)mk_modelToJSONString;
 ...
 */
+ (nullable NSArray *)mk_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (MKModel)
 ...
 */
+ (nullable NSDictionary *)mk_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)mk_modelCustomPropertyMapper;
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)mk_modelContainerPropertyGenericClass;
 ...
 */
+ (nullable Class)mk_modelCustomClassForDictionary:(NSDictionary *)dictionary;
 ...
 */
+ (nullable NSArray<NSString *> *)mk_modelPropertyBlacklist;
...
/**
 ...
 @return An array of property's name.
 */
+ (nullable NSArray<NSString *> *)mk_modelPropertyWhitelist;
 ...
 */
- (NSDictionary *)mk_modelCustomWillTransformFromDictionary:(NSDictionary *)dic;
 ...
 */
- (BOOL)mk_modelCustomTransformFromDictionary:(NSDictionary *)dic;
...
/**
 ...
 @return Returns YES if the model is valid, or NO to ignore this model.
 */
- (BOOL)mk_modelCustomTransformToDictionary:(NSMutableDictionary *)dic;
