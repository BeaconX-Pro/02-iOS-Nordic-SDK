...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MKBeaconXPlus/MKBeaconXPlus.framework"
  ...
  install_framework "${PODS_ROOT}/MTBeaconPlus/MTBeaconPlus/Frameworks/MTBeaconPlus.framework"
