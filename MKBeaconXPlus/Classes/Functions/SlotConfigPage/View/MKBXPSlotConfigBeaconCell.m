...
@implementation MKBXPSlotConfigBeaconCellModel
@end

@interface MKBXPSlotConfigBeaconCell ()
...
@implementation MKBXPSlotConfigBeaconCell

+ (MKBXPSlotConfigBeaconCell *)initCellWithTableView:(UITableView *)tableView {
    MKBXPSlotConfigBeaconCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBXPSlotConfigBeaconCellIdenty"];
    if (!cell) {
        cell = [[MKBXPSlotConfigBeaconCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBXPSlotConfigBeaconCellIdenty"];
    }
    return cell;
}
...
- (NSDictionary *)bxp_slotConfigCell_paramValue {
    ...
    return @{
        ...
        @"result":@{
                ...
                @"params":@{
                        @"frameType":bxp_slotConfig_beaconData,
...
#pragma mark - setter
- (void)setDataModel:(MKBXPSlotConfigBeaconCellModel *)dataModel {
    _dataModel = nil;
...
- (UIImageView *)leftIcon{
    if (!_leftIcon) {
        ...
        _leftIcon.image = LOADICON(@"MKBeaconXPlus", @"MKBXPSlotConfigBeaconCell", @"bxp_slot_advContent.png");
    }
    return _leftIcon;
}
