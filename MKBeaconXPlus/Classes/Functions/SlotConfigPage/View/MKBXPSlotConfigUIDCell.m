...
@implementation MKBXPSlotConfigUIDCellModel
@end

@interface MKBXPSlotConfigUIDCell ()
...
@implementation MKBXPSlotConfigUIDCell

+ (MKBXPSlotConfigUIDCell *)initCellWithTableView:(UITableView *)tableView {
    MKBXPSlotConfigUIDCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBXPSlotConfigUIDCellIdenty"];
    if (!cell) {
        cell = [[MKBXPSlotConfigUIDCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBXPSlotConfigUIDCellIdenty"];
    }
    return cell;
}
...
- (NSDictionary *)bxp_slotConfigCell_paramValue {
    ...
    return @{
        ...
        @"result":@{
                ...
                @"params":@{
                        @"frameType":bxp_slotConfig_uidData,
...
#pragma mark - setter
- (void)setDataModel:(MKBXPSlotConfigUIDCellModel *)dataModel {
    _dataModel = nil;
