...
@implementation MKBXPScanBeaconCell

+ (MKBXPScanBeaconCell *)initCellWithTableView:(UITableView *)tableView{
    MKBXPScanBeaconCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBXPScanBeaconCellIdenty"];
    if (!cell) {
        cell = [[MKBXPScanBeaconCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBXPScanBeaconCellIdenty"];
    }
    return cell;
}
...
- (UIImageView *)leftIcon{
    if (!_leftIcon) {
        ...
        _leftIcon.image = LOADICON(@"MKBeaconXPlus", @"MKBXPScanBeaconCell", @"bxp_littleBluePoint.png");
    }
    return _leftIcon;
}
