...
@implementation MKBXPSearchButtonModel
@end

@interface MKBXPScanSearchButton ()
...
@implementation MKBXPScanSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(bxp_scanSearchButtonClearMethod)]) {
        [self.delegate bxp_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(bxp_scanSearchButtonMethod)]) {
        [self.delegate bxp_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKBXPSearchButtonModel *)dataModel {
    _dataModel = nil;
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"MKBeaconXPlus", @"MKBXPScanSearchButton", @"bxp_scanFilter_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"MKBeaconXPlus", @"MKBXPScanSearchButton", @"bxp_scanFilter_clearButtonIcon.png") forState:UIControlStateNormal];
