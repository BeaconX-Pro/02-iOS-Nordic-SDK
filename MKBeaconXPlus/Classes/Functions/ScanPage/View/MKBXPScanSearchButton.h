...
@interface MKBXPSearchButtonModel : NSObject
...
@protocol MKBXPSearchButtonDelegate <NSObject>
...
@interface MKBXPScanSearchButton : UIControl

@property (nonatomic, strong)MKBXPSearchButtonModel *dataModel;

@property (nonatomic, weak)id <MKBXPSearchButtonDelegate>delegate;
