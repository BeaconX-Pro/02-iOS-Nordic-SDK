...
@interface MKBXPScanFilterView()<UIGestureRecognizerDelegate>
...
@implementation MKBXPScanFilterView

- (void)dealloc{
    NSLog(@"MKBXPScanFilterView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKBXPScanFilterView *view = [[MKBXPScanFilterView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKBeaconXPlus", @"MKBXPScanFilterView", @"bxp_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKBeaconXPlus", @"MKBXPScanFilterView", @"bxp_wifiGraySignalIcon.png");
    }
