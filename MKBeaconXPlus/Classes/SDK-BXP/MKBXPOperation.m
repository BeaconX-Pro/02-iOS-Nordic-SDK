...
NSString *const mk_bxp_additionalInformation = @"mk_bxp_additionalInformation";
NSString *const mk_bxp_dataInformation = @"mk_bxp_dataInformation";
NSString *const mk_bxp_dataStatusLev = @"mk_bxp_dataStatusLev";
...
/**
 线程结束时候的回调
 */
@property (nonatomic, copy)void (^completeBlock) (NSError *error, mk_bxp_taskOperationID operationID, id returnData);
    ...
    if (self.completeBlock) {
        if (self.needPartOfData) {
            ...
            NSDictionary *resultDic = @{
                                        mk_bxp_additionalInformation:(self.additionalInformation ?: @{}),
                                        mk_bxp_dataInformation:self.dataList,
                                        //对于有附加信息的，lev为2，对于普通不包含附加信息的，lev为1.
                                        mk_bxp_dataStatusLev:(self.additionalInformation ? @"2" : @"1"),
                                        };
            if (self.completeBlock) {
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    NSString *numString = returnData[mk_bxp_communicationDataNum];
